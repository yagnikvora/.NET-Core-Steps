     ...
     try
     {
         if (ModelState.IsValid)
         {
             ...
             if (dataTable.Rows.Count > 0)
             {
                 ...
                 return RedirectToAction("CityList", "City", new { area = "LOC_City" });
             }
             else
             {
                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3" asp-action="Login" asp-controller="User">
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0">Don't have account? <a asp-action="Register" asp-controller="User">Create an account</a></p>
                                    </div>
                                </form>
